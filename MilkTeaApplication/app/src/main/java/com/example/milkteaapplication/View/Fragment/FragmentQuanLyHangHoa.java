    ...
    private void ThemHoaDonNhapHang() {
        ...
        builder.setPositiveButton("Thêm", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                String soLuongNhap = edtSoLuongNhap.getText().toString();
                ...
                if (TextUtils.isEmpty(maHDNhap)) {
                    ...
                    return;
                } else if (TextUtils.isEmpty(soLuongNhap)) {
                    Toast.makeText(myContext, "Nhập vào số lương", Toast.LENGTH_SHORT).show();
                    return;
                } else if (TextUtils.isEmpty(giaNhap)) {
        ...
        db_hdNhap.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()
                    ...
                    int pValue = Integer.parseInt(String.valueOf(giaTienNhap));
                    sum += pValue;
