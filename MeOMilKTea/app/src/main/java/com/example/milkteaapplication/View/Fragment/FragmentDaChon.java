    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnThanhToan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (datMons.size()==0){
                    Toast.makeText(getContext(), "Chưa có món được chọn!", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    builder.setMessage("Bạn muốn thanh toán bàn " + Common.TABLE + " ?")
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    //cap nhat tinh trang mon an cua ban an ve ""
                                    DatabaseReference doiHoanThanh = database.getReference("BanAn").child(Common.TABLEID).child("hoanThanh");
                                    doiHoanThanh.setValue("");
