...
public class DatMonDAO {
    ...
    public DatMonDAO(Context context) {
        this.reference = FirebaseDatabase.getInstance().getReference("MonDaChon").child(Common.BEPTABLE);
    ...
    public List<DatMon> getDatMonsPhaChe() {
        datMons = new ArrayList<>();
        ...
        ValueEventListener listener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ((PhaCheActivity) context).CapNhatRV();
            }
