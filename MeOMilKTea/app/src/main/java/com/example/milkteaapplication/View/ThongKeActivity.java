...
public class ThongKeActivity extends AppCompatActivity {
    Toolbar toolbar;
    TextView tvDoanhThu, tvChiPhi, tvNgayHoaDon, tvTongTienNgay, tvTongTienThang, tvTongTienNam;
    Button btndate, btnThongKeNgay, btnThongKeThang, btnThongKeNam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnThongKeThang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HoaDonDao hoaDonDao = new HoaDonDao(ThongKeActivity.this);
                hoaDonDao.getTongTienTheoThang(tvNgayHoaDon.getText().toString(),tvTongTienThang);
            }
        });
        btnThongKeNam.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HoaDonDao hoaDonDao = new HoaDonDao(ThongKeActivity.this);
                hoaDonDao.getTongTienTheoNam(tvNgayHoaDon.getText().toString(),tvTongTienNam);
            }
        });
    }
    ...
    private void anhxa() {
        ...
        tvTongTienThang = findViewById(R.id.tvTongTienThang);
        tvTongTienNam = findViewById(R.id.tvTongTienNam);
        btndate = findViewById(R.id.btndate);
        btnThongKeNgay = findViewById(R.id.btnThongKeNgay);
        btnThongKeThang = findViewById(R.id.btnThongKeThang);
        btnThongKeNam = findViewById(R.id.btnThongKeNam);
